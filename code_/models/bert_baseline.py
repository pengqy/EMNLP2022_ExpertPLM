...
class Bert_base(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.bert_encoder_a = BertModel.from_pretrained('./bert_pretrain/checkpoints/mlm_user_modeling/')
        self.bert_encoder_b = BertModel.from_pretrained('./bert_pretrain/checkpoints/mlm_user_modeling/')
