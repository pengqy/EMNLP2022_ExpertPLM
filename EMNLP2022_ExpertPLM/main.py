...
import models
import tokenizers
from models import Bert_encoder
...
def collate_fn(batch):
    ...
    '''
    # label, q_id, a_id, q_title, q_body, q_tag, aid_q_titles, aid_q_bodys, aid_q_tags, bid_input, bid_type, batt_mask = zip(*batch)
    ...
    return label, q_id, a_id, bid_input, bid_type, batt_mask, qid_input, qid_type, qatt_mask # torch.tensor(bid_input), torch.tensor(bid_type), torch.tensor(batt_mask)
